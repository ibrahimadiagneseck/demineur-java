...
public class Graphisme {
	...
	public static VolatileImage drapeau, question, questionSelectionnee, mine, boum, erreur;
	...
	public Graphisme(GraphicsConfiguration graphicsConfiguration) {
		...
		boum = graphicsConfiguration.createCompatibleVolatileImage(16, 16);

		// Récupération d'un objet Graphics2D pour dessiner sur l'image
		graphics2D = (Graphics2D) boum.getGraphics();
